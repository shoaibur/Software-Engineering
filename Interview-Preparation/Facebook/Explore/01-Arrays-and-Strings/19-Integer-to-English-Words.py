def numberToWords(num):
    ...
    onedigit = {1: 'One', 2: 'Two', 3: 'Three', 4: 'Four', 5: 'Five', 
                6: 'Six', 7: 'Seven', 8: 'Eight', 9: 'Nine'}
    twodigits_10to19 = {10: 'Ten', 11: 'Eleven', 12: 'Twelve', 13: 'Thirteen', 
    ...
    def two(num):
        if num < 20: return twodigits_10to19[num]
        ty, rest = divmod(num, 10)
        if ty and rest:
            return tens[ty] + ' ' + one(rest)
        elif ty and not rest:
            return tens[ty]
        '''
